...
Function InitItemTemplates()
	...
	CreateItemTemplate("Scientist Key Card", "key0",  "GFX\items\keycard.x", "GFX\items\INVkey1.jpg", "", 0.0004,"GFX\items\keycardsec.jpg")
	...
	it = CreateItemTemplate("Dr. Pari's Note", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "GFX\items\docLevelTwo.jpg", 0.1) : it\sound = 0
	...
	it = CreateItemTemplate("First Aid Kit", "firstaid", "GFX\items\firstaid2.x", "GFX\items\INVfirstaidnew.png", "", 1)
