				...
				Case 0
					...
					If temp Then 
						If Rand(15)=1 Then 
							Select Rand(13)
								Case 1 
									RandomSeed = "IT S33S @LL"
								Case 2
									RandomSeed = "Y0UC@NN0TESC@P3"
								Case 3
									RandomSeed = "d9341"
								Case 4
									RandomSeed = "5CP_I73"
	...
	Else
		...
		Select MainMenuTab
			Case 1 ; New game
				...
				AAText(x + 20 * MenuScale, y + 110 * MenuScale, "Intro Sequence:")
				...
				If DrawButton(x + 420 * MenuScale, y + height + 20 * MenuScale, 160 * MenuScale, 70 * MenuScale, "PROCEED", False) Then
			...
			Case 3,5,6,7 ;options
				...
				Color 255,255,255
				If DrawButton(x+20*MenuScale,y+15*MenuScale,width/5,height/2, "Visuals", False) Then MainMenuTab = 3
				If DrawButton(x+160*MenuScale,y+15*MenuScale,width/5,height/2, "Sound", False) Then MainMenuTab = 5
				If DrawButton(x+300*MenuScale,y+15*MenuScale,width/5,height/2, "Ctrls+Binds", False) Then MainMenuTab = 6
				If DrawButton(x+440*MenuScale,y+15*MenuScale,width/5,height/2, "Misc", False) Then MainMenuTab = 7
				...
				ElseIf MainMenuTab = 7 ;Advanced
					...
					Color 255,255,255
					AAText(x + 20 * MenuScale, y, "Unlockables popups:")
...
Function UpdateLauncher()
	...
	Font1 = LoadFont_Strict("GFX\font\TI\TI-83.ttf", 18, 0,0,0)
	SetFont Font1
	MenuWhite = LoadImage_Strict("GFX\menu\menuwhite.jpg")
	MenuBlack = LoadImage_Strict("GFX\menu\menublack.jpg")	
	MaskImage MenuBlack, 255,255,0
